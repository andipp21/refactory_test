        ...
        children: [
          Padding(
              padding: const EdgeInsets.symmetric(vertical: 32),
                child: RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: < TextSpan > [
                      TextSpan(text: 'meningkatkan skill', style: TextStyle(color: kSecondaryColor)),
                      TextSpan(text: ' anda.'),
                    ],
                  ),
                ),
            ...
            Padding(
              ...
              child: Image.network('https://i0.wp.com/refactory.id/wp-content/uploads/2020/07/Frame.png?fit=839%2C481&ssl=1')
              )
        ],
      ),
    );
