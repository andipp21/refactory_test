        ...
        children: [
          Padding(
            padding: const EdgeInsets.symmetric(vertical: 16.0),
              child: Text('Tentang Course', style: TextStyle(fontSize: 24), ),
          ),
          //Tentang Course
          Text(dc.shortDescription, textAlign: TextAlign.center, ),


          Padding(
            padding: const EdgeInsets.only(top: 48.0, bottom: 16),
              child: Text('Materi Course', style: TextStyle(fontSize: 24), ),
          ),
              ...
              return Container(
                ...
                child: Card(
                  child: Padding(
                    padding: const EdgeInsets.symmetric(vertical: 16.0),
                    child: ListTile(
                      title: Text(lmc[i].section, style: TextStyle(fontWeight: FontWeight.bold),),
                      subtitle: Column(
                        children: [
                          ListView.builder(
                            physics: NeverScrollableScrollPhysics(),
                            ...
                            itemBuilder: (BuildContext context, int idx) {
                              return Container(
                                ...
                                child: ListTile(
                                  leading: FaIcon(FontAwesomeIcons.youtube, size: 20,),
                                  title: Text('${ldc[i].title} (${ldc[i].timeIn})', style: TextStyle(fontSize: 14),),
